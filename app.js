...
function sendWelcomemessage(recipientId) {
  ...
  var nameString = "Ol� " + firstName + " " + lastName + ", Iremos responder assim que poss�vel! Caso queira informa��es para Aumento de Potencia ou Solu��o FAP, pode consultar o nosso Website. Se pretender o or�amento, Indique-nos a Marca/modelo/ano/motoriza��o do seu veiculo!";
  var messageData = {
    recipient: {
      id: recipientId
    },
